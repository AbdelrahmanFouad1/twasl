...
class SettingsScreen extends StatelessWidget {
  ...
  Widget buildProfilePost(context) => Builder(
        builder: (BuildContext context) {
          ...
          return Expanded(
            child: Conditional.single(
              ...
              fallbackBuilder: (BuildContext context) => buildPostShimmerSettingItem (context),
            ),
          );
        },
      );

  Widget buildPostSettingItem(PostModel model, context, index) => Builder(
        builder: (BuildContext context) {
          if (model.uId == uId) {
            return Card(
  ...
  Widget buildPostShimmerSettingItem ( context) => Builder(
    builder: (BuildContext context) {
      return Card(
        clipBehavior: Clip.antiAliasWithSaveLayer,
        elevation: 8.0,
